package com.zjl.iwechatmoments.core.view;
...
import com.zjl.iwechatmoments.core.adapter.WrapperRecyclerViewAdapter;
...
//                    smoothScrollToPosition(totalCount);
                ...
                if (firstVisible == 0) {
                    ...
                    isTop = false;
                    LayoutParams params = (LayoutParams) getHeaderView(0).getLayoutParams();
                    params.width = LayoutParams.MATCH_PARENT;
                    params.height = LayoutParams.WRAP_CONTENT;
    ...
    public void touchUp() {
        if (!isRefreshing && (endY -startY) != 0 ) {
            ...
            LayoutParams params1 = (LayoutParams) getHeaderView(0).getLayoutParams();
...
//        params.setMargins(0, - 130, 0, 0);
    ...
    public void setLoadMoreComplete() {
        LayoutParams params = (LayoutParams) getFooterView(0).getLayoutParams();
        params.width = 0;
        params.height = 0;
        getFooterView(0).setLayoutParams(params);
